    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('s_model_choice', models.CharField(blank=True, choices=[('SAGE_USER_LIST', 'SAGEUserList'), ('CONTROL_AD_USER', 'ControlADUser'), ('CHANGE_REQUESTS', 'ChangeRequests'), ('HR_USER_LIST', 'HRUserList'), ('TICKET_LOGGING', 'TicketLogging'), ('UNIFIED_ACCESS_MANAGEMENT', 'UnifiedAccessManagement'), ('FAVORITE', 'Favorite'), ('UNIQUE', 'Unique'), ('FINDING', 'Finding'), ('TAB', 'Tab'), ('COPY_DT', 'Copy DT'), ('FINDING_VIEW', 'Finding View'), ('IMAGE_LOADER', 'Image Loader'), ('IMAGES', 'Images'), ('FINDING_ATTACHMENT', 'Finding Attachment')], max_length=255, null=True, verbose_name='Source Model Choice')),
